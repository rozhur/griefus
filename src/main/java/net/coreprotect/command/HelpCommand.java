...
public class HelpCommand {
            ...
            if (resultc > 1) {
                ...
                if (helpcommand.equals("help")) {
                    Chat.sendMessage(player, Phrase.build(Phrase.HELP_CO_HELP));
                        ...
                        player.hasPermission("griefus.inspect")) {
                    ...
                    Chat.sendMessage(player, Phrase.build(Phrase.HELP_PARAMS_EXCLUDE));
                        ...
                        player.hasPermission("griefus.rollback")) {
                    ...
                    Chat.sendMessage(player, Phrase.build(Phrase.HELP_ROLLBACK_EXCLUDE));
                        ...
                        player.hasPermission("griefus.restore")) {
                    ...
                    Chat.sendMessage(player, Phrase.build(Phrase.HELP_RESTORE_EXCLUDE));
                        ...
                        player.hasPermission("griefus.lookup")) {
                    ...
                    Chat.sendMessage(player, Phrase.build(Phrase.HELP_LOOKUP_PAGE));
                        ...
                        player.hasPermission("griefus.purge")) {
                ...
                } else if (helpcommand.equals("reload") && player.hasPermission("griefus.reload")) {
                    Chat.sendMessage(player, Phrase.build(Phrase.HELP_RELOAD));
                } else if (helpcommand.equals("status") && player.hasPermission("griefus.status")) {
                    Chat.sendMessage(player, Phrase.build(Phrase.HELP_STATUS));
                } else if (helpcommand.equals("teleport") && player.hasPermission("griefus.teleport")) {
                    Chat.sendMessage(player, Phrase.build(Phrase.HELP_TELEPORT));
                        ...
                        canLookupRollbackRestorePurge(player)) {
                ...
                if (player.hasPermission("griefus.inspect")) Chat.sendMessage(player, Phrase.build(Phrase.HELP_MAIN_INSPECT));
                if (player.hasPermission("griefus.rollback")) Chat.sendMessage(player, Phrase.build(Phrase.HELP_MAIN_ROLLBACK));
                if (player.hasPermission("griefus.restore")) Chat.sendMessage(player, Phrase.build(Phrase.HELP_MAIN_RESTORE));
                if (player.hasPermission("griefus.lookup")) Chat.sendMessage(player, Phrase.build(Phrase.HELP_MAIN_LOOKUP));
                if (player.hasPermission("griefus.purge")) Chat.sendMessage(player, Phrase.build(Phrase.HELP_MAIN_PURGE));
                if (player.hasPermission("griefus.reload")) Chat.sendMessage(player, Phrase.build(Phrase.HELP_MAIN_RELOAD));
                if (player.hasPermission("griefus.status")) Chat.sendMessage(player, Phrase.build(Phrase.HELP_MAIN_STATUS));
            }
        } else {
    ...
    private static boolean canLookupRollbackRestorePurge(CommandSender player) {
        return player.hasPermission("griefus.lookup") ||
                player.hasPermission("griefus.rollback") ||
                player.hasPermission("griefus.restore") ||
                player.hasPermission("griefus.purge");
    }
