        ...
        if (commandName.equals("core") || commandName.equals("coreprotect") || commandName.equals("co") || commandName.equals("griefus") || commandName.equals("gus")) {
            ...
            if (resultc > -1) {
                ...
                if (corecommand.equals("rollback") || corecommand.equals("restore") || corecommand.equals("rb") || corecommand.equals("rs") || corecommand.equals("ro") || corecommand.equals("re")) {
                    ...
                    Chat.sendMessage(user, Phrase.build(Phrase.COMMAND_NOT_FOUND, Color.WHITE, '/' + commandLabel + ' ' + corecommand));
                }
            }
            else {
                Chat.sendMessage(user, Phrase.build(Phrase.MISSING_PARAMETERS, Color.WHITE, '/' + commandLabel + " <parameters>"));
            }
